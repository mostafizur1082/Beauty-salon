		...
		<div class="card" style="magin-top:2px;">
			<div class="card-body">
				<div class="row">
					...
					<div class="col-8"></div>
					<div class="col-2">
						<a class="btn btn-outline-success mb-1 d-block" href="{{ route('admin.category.create') }}">
                        Add
                        </a>
					</div>
				</div>
            ...
            <div class="table-responsive-sm">
                 <table class="table table-bordered table-centered mb-0">
                    ...
                    <tbody>
                        ...
                        <a class="btn btn-primary" href="{{ route('admin.category.edit',$category->id) }}"><i class="mdi mdi-pencil"></i></a>
                        @csrf
                        @method('DELETE')
