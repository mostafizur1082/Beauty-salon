            ...
            <div class="table-responsive-sm">
                 <table class="table table-bordered table-centered mb-0">
                    ...
                    <tbody>
                        ...
                        <form action="{{ route('receptionist.contact.destroy',$contact->id) }}" method="POST">
                        <a class="btn btn-primary" href="{{ route('receptionist.contact.edit',$contact->id) }}"><i class="ri-eye-line"></i></a>
                        @csrf
                        @method('DELETE')
