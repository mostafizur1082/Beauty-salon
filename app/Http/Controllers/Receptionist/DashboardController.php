...
class DashboardController extends Controller
{
   public function index(){
        ...
        return view('receptionist.dashboard',compact('blogs','total_pending_blogs','user_count','receptionist_count','new_user_today','category_count','tag_count','services_count'));
    }
}
